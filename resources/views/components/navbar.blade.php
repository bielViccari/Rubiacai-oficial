...
<button id="sidebarToggle" type="button" class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
 ...
 <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto  {{ request()->routeIs('create.products') || request()->routeIs('edit.product') ? 'bg-gray-200' : 'bg-gray-50' }}">
       <ul class="space-y-2 font-medium">
          <li>
             <a href="{{ route('dashboard') }}" class="flex items-center p-2 {{ request()->routeIs('dashboard') ? 'text-white bg-gray-300 cursor-pointer rounded' : 'text-gray-900 rounded-lg cursor-pointer  hover:bg-gray-100' }} group">
          ...
          <li>
             <a href="{{ route('pagina.inicial') }}" class="flex items-center p-2 {{ request()->routeIs('pagina.inicial') ? 'text-white bg-gray-300 cursor-pointer rounded' : 'text-gray-900 rounded-lg cursor-pointer hover:bg-gray-100 ' }} group">
          ...
          <li>
             <a href="{{ route('create.products') }}" class="flex items-center p-2 {{ request()->routeIs('create.products') ? 'text-white bg-gray-300 cursor-pointer rounded' : 'text-gray-900 rounded-lg cursor-pointer hover:bg-gray-100 ' }} group">
        ...
        <li>
           <a href="{{ route('profile') }}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100  group">
          ...
          <li>
             <a wire:click='logout' class="flex items-center p-2 cursor-pointer text-gray-900 rounded-lg hover:bg-gray-100  group">
