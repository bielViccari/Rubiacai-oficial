    ...
    <div class="max-w-sm mx-auto mt-20 bg-white rounded-md shadow-md overflow-hidden">
        ...
        <div class="px-6 py-4">
            ...
            <div class="mb-4">
                ...
                <input wire:model='image' class="block w-full mb-5 text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="small_size" type="file">
                @error('image')
                <span class="mt-2 text-xs text-red-600 dark:text-red-400">{{ $message }}</span>
                @enderror
            </div>
